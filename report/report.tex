...
Talk about hardware implementations.
Physical training time with inference learning not equal to time in correct hardware.
We might want to thing about if the hardware we build is rightly suited for the task.
